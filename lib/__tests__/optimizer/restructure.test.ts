...
function scenario(dreamTotal = 0.75) {
  ...
  // 15-player ranked squad: top3, downgraded at rank4 (index 3), fillers, weakest3.
  ...
  const analysis = makeSquadAnalysisResult({ rankedSquad, weakest3, bank: 0.5, currentGw: 20 });
