...
for (let gw = 4; gw <= 38; gw++) {
  ...
  const valid = buildValidTransfers(
    { rankedSquad: scored, weakSpots, picks: prev.picks, chipsRemaining: { wildcard: 0, freeHit: 0, benchBoost: 0, tripleCaptain: 0 }, bank, currentGw: gw, deadline: null, squadGw: gw - 1, inPlayGw: null, generatedAt: "" },
    bank, teamCounts);
